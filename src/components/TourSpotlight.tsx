...
export const TourSpotlight: React.FC<TourSpotlightProps> = ({ isOpen, onClose, setActiveTab }) => {
  ...
  const tourSteps = [
    {
      title: 'Welcome to BhuNex Studio',
      desc: 'An all-in-one offline geomatics, GNSS field surveyor, and cadastral mapping suite developed by Md Salim Ansari.',
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-[#0f0f0f] rounded-2xl shadow-2xl border border-white/10 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-150 cursor-default"
