...
export async function executeGeomaticsAi(
  ...
  const systemPrompt = `You are the AI Spatial Copilot for BhuNex Studio. Answer surveying, GIS, cadastral, and mining engineering questions with precision. If geometry is needed, include a JSON codeblock with GeoFeature[] points (Easting/Northing in UTM Zone ${context.workingZone || '45N'} centered near E: ${context.centerCoord?.E || 255000}, N: ${context.centerCoord?.N || 2605000}).`;
